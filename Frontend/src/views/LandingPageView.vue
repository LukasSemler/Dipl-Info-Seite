      ...
      <main class="mx-auto mt-16 max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span class="block xl:inline">Coming Home</span>
            {{ ' ' }}
            <span class="block text-sky-500 xl:inline">Safe</span>
          </h1>
          <p
            class="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
          >
            Kommen Sie mithilfe von Coming Come Safe sicher zu Hause an. Coming Home Safe bietet
            Ihnen einen Service an, welcher Ihnen dabei hilft, sich sicher zu fühlen, wenn Sie nach
            Hause kommen.
          </p>
          <div class="mx-auto mt-5 max-w-md sm:flex sm:justify-center md:mt-8">
            <div class="rounded-md shadow">
              <a
                ...
                class="flex w-full items-center justify-center rounded-md border border-transparent bg-sky-500 px-8 py-3 text-base font-medium text-white hover:bg-sky-600 md:py-4 md:px-10 md:text-lg"
                >Get started</a
              >
            </div>
          </div>
  ...
  <div class="bg-sky-500">
    <div class="mx-auto max-w-2xl py-16 px-4 text-center sm:py-20 sm:px-6 lg:px-8">
      ...
      <p class="mt-4 text-lg leading-6 text-white">
        ...
        beide Schüler der HTL Wien West
      </p>
    </div>
  </div>
  ...
  <div>
    <div class="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
        <div class="col-span-2 flex justify-center md:col-span- lg:col-span-5">
          <img class="h-20" src="/Coming-Home-Safe-Icon.webp" alt="GM" />
        </div>
      </div>
    </div>
  </div>
